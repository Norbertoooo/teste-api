...
import br.com.teste.api.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link br.com.teste.api.domain.Funcionario}.
 */
@RestController
@RequestMapping("/api")
public class FuncionarioResource {
    ...
    private static final String ENTITY_NAME = "testeApiFuncionario";
